...
public class SettingsWatcher {
    ...
    public SettingsWatcher(ConfigService configService, ProjectPromptLoader projectPromptLoader) {
    ...
    public void init() {
        try {
            ...
            Path configDir = Path.of(System.getProperty("user.home"), ".zhikun");
            ...
            try {
                ...
                for (WatchEvent<?> event : key.pollEvents()) {
                    ...
                    if (changed.toString().endsWith(".md") || changed.toString().endsWith(".yml")) {
                        ...
                        projectPromptLoader.clearCache();
